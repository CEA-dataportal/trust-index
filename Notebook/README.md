...
- A brief overview of its objective within the CTI workflow
- R code for data extraction, cleaning, and harmonization
- R code for weighting process
- Procedures to calculate standardized CTI scores
- Notes on quality assurance and methodological consistency
